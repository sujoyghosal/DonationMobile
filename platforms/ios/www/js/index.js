...
var appName = "freecycleprod";
var notifier = "freecycleapple";
...
var app = {
    ...
    onDeviceReady: function() {
        alert("onDeviceReady");
        console.log("Calling Apigee.Client");
        ...
        function tokenHandler(status) {
            if (status) {
                ...
                client.registerDevice(options, function(error, result) {
                    if (error) {
                        console.log("#### In registerDevice error");
                        console.log(error);
                    } else {
                        console.log("#### In registerDevice success");
                        console.log(result);
                    }
                });
            }
